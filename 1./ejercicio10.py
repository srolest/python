...
payaso = 112
muñeca = 75
numeropayasos = float(input("Introduce el numero de payasos vendidos:"))
numeromuñecas = float(input("Introduce el numero de muñecas vendidas:"))
print("El peso total del paquete es:",(numeropayasos*payaso)+(numeromuñecas*muñeca))